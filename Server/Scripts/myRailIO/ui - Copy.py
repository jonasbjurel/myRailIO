...
class UI_mainWindow(QMainWindow):
    ...
    def connectWidgetSignalsSlots(self):
        ...
        # Alarm inventory widget
        self.alarmPushButton.clicked.connect(self.showAlarmInventory)
...
class UI_individualAlarmShowDialog(QDialog):
    ...
    def _populate(self):
        ...
        #DEBUG PRINTOUT
        if alarm[self.parent.alarmTableModel.parentAlarmInstanceCol(True) + 1] != None:
            self.transIdTextEdit.setText(str(alarm[self.parent.alarmTableModel.parentAlarmInstanceCol(True) + 1]))
        else:
            self.transIdTextEdit.setText("-")
        self.referencesTextEdit.setText(str(alarm[self.parent.alarmTableModel.parentAlarmInstanceCol(True) + 2]))
        self.origAlarmIdTextEdit.setText(str(alarm[self.parent.alarmTableModel.parentAlarmInstanceCol(True) + 3]))


        self.parentAlarmIdTextEdit.setText(alarm[self.parent.alarmTableModel.parentAlarmInstanceCol(True)])
