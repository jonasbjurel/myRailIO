...
// Payload examples:
#define FETCHOPSTATE_PAYLOAD					"<OPSTATE/>"
...
#define MQTT_DECODER_WIFISTATUS_TOPIC			MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_DECODER_TOPIC_FRAGMENT "/wifistatus"
#define DELIVERWIFISTATUS_XMLTAG_PAYLOAD		"WIFISTATUS"

// Memory status notification
#define MQTT_DECODER_MEMSTATUS_TOPIC			MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_DECODER_TOPIC_FRAGMENT "/memstatus"
#define DELIVERMEMSTATUS_XMLTAG_PAYLOAD			"MEMSTATUS"

// Log overload status notification
#define MQTT_DECODER_LOGOVERLOAD_TOPIC			MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_DECODER_TOPIC_FRAGMENT "/logoverload"
#define DELIVERLOGOVERLOAD_XMLTAG_PAYLOAD		"LOGOVERLOAD"

// CLI Client connection status notification
#define MQTT_DECODER_CLIACCESS_TOPIC			MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_DECODER_TOPIC_FRAGMENT "/cliaccess"
#define DELIVERCLIACCESS_XMLTAG_PAYLOAD			"CLIENT"

// CLI Debug flag status notification
#define MQTT_DECODER_DEBUG_TOPIC				MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_DECODER_TOPIC_FRAGMENT "/debug"
#define DELIVERDEBUG_XMLTAG_PAYLOAD				"DEBUG"

// NTP status notification
 #define MQTT_DECODER_NTPSTATUS_TOPIC			MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_DECODER_TOPIC_FRAGMENT "/ntpstatus"
#define DELIVERNTPSTATUS_XMLTAG_PAYLOAD			"NTPSTATUS"
// 
