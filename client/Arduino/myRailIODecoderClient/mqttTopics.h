...
#define MQTT_DISCOVERY_REQUEST_PAYLOAD			"DISCOVERY_REQUEST"				//Used for the discovery request payload:	<MQTT_DISCOVERY_REQUEST_PAYLOAD>
#define MQTT_DISCOVERY_REQUEST_PAYLOAD_MAC		"MAC"							//												<MQTT_DISCOVERY_REQUEST_PAYLOAD_MAC>{MAC ADDRESS}</MQTT_DISCOVERY_REQUEST_PAYLOAD_MAC>
#define MQTT_DISCOVERY_REQUEST_PAYLOAD_HWVER	"HWVER"							//												<MQTT_DISCOVERY_REQUEST_PAYLOAD_HWVER>{HARDWARE VERSION}</MQTT_DISCOVERY_REQUEST_PAYLOAD_HWVER>
#define MQTT_DISCOVERY_REQUEST_PAYLOAD_FWVER	"FWVER"							//												<MQTT_DISCOVERY_REQUEST_PAYLOAD_FWVER>{FIRMWARE VERSION}</MQTT_DISCOVERY_REQUEST_PAYLOAD_FWVER>
