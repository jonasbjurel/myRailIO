...
/*              In the captive portal WiFi- and MQTT- parameters can be configured after which the myRailIOdecoder will connect to the given     */
/*              Access-point. If the pushbutton <WIFI_CONFIG_PB_PIN> is pushed for more than 30 seconds after                                   */
/*              networking::provisioningConfigTrigger() has been called, the myRailIOdecoder will be reset to factory default, the filesystem    */
/*              for the configuration file(s) will be re-formatted, and the provisioning Access point is started.                               */
/*              If "Erase WiFi config" is activated inside the captive provisioning portal the myRailIOdecoder will be reset to factory default, */
...
/*              the myRailIOdecoder will not start the provisioning Access point, but will try to connect to the Access point defined by the     */
