...
lgsDecoder* topDecoder::lighGroupsDecoder_0;
lgsDecoder* topDecoder::lighGroupsDecoder_1;
lgsDecoder* topDecoder::lighGroupsDecoder_2;
lgsDecoder* topDecoder::lighGroupsDecoder_3;
...
uint8_t topDecoder::init(void){
  ...
  lightgropsCliContext->cliContext = (char*)"lightgroups";
  lightgropsCliContext->cliContextInitCb = lightgropsCliContextInit;
  ...
  const char* subscribeTopic[3] = {MQTT_CONFIG_TOPIC, mqtt::getUri(), "/"};
...
void topDecoder::lightgropsCliContextInit(void){
