...
#define MQTT_TURN_ADMSTATE_TOPIC				MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_TURN_TOPIC_FRAGMENT "/" MQTT_ADMSTATE_TOPIC_FRAGMENT		//followed by /uri/sysname
#define MQTT_LIGHT_ADMSTATE_TOPIC				MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_LIGHT_TOPIC_FRAGMENT "/" MQTT_ADMSTATE_TOPIC_FRAGMENT		//followed by /uri/sysname
#define MQTT_MEMORY_ADMSTATE_TOPIC				MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_MEMORY_TOPIC_FRAGMENT "/" MQTT_ADMSTATE_TOPIC_FRAGMENT		//followed by /uri/sysname
...
#define MQTT_TURN_OPSTATE_TOPIC					MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_TURN_TOPIC_FRAGMENT "/" MQTT_OPSTATE_TOPIC_FRAGMENT			//followed by /uri/sysname
#define MQTT_LIGHT_OPSTATE_TOPIC				MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_LIGHT_TOPIC_FRAGMENT "/" MQTT_OPSTATE_TOPIC_FRAGMENT			//followed by /uri/sysname
#define MQTT_MEMORY_OPSTATE_TOPIC				MQTT_PRE_TOPIC_DEFAULT_FRAGMENT "/" MQTT_MEMORY_TOPIC_FRAGMENT "/" MQTT_OPSTATE_TOPIC_FRAGMENT			//followed by /uri/sysname
